...
class AdminToolsMod(loader.Module):
    ...
    strings = {'name': 'Admin Tools',
               ...
               'pin_none': '<b>Что нужно отодрать?.</b>',
               ...
               'kick_none': '<b>Нет кого прогонять.</b>',
               'kicked': '<b>{} Был вышвырнут.</b>',
               'kicked_for_reason': '<b>{} Был вышвырнут.\nReason: {}.</b>',
               'banning': '<b>Баню...</b>',
               'banned': '<b>{} Забанил.</b>',
               'banned_for_reason': '<b>{} Был лишён доступа в группу.\nReason: {}</b>',
               'ban_none': '<b>Нет кого банить.</b>',
               'unban_none': '<b>Нет кого разбанить.</b>',
               'unbanned': '<b>{} Был прощён.</b>',
               'mute_none': '<b>Нет кого мутить.</b>',
               'muted': '<b>{} Был заткнут </b>',
               'no_args': '<b>Плохие аргументы.</b>',
               'unmute_none': '<b>Нет кого размутить.</b>',
               'unmuted': '<b>{} Теперь заткнут.</b>',
